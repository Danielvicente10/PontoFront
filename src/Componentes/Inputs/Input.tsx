...
const Input: React.FC<InputProps> = ({ title, value, onChange }) => {
    return (
        <div>
            ...
            <input type="email" className='containerIndex' value={value} onChange={onChange} placeholder='Digite seu e-mail.'/>
        </div>
    );
}
    ...
    return (
        ...
        <div>
            ...
            <div className='password-container'>
                <input type={isShow? "text" : "password"} className='containerIndex' value={value} onChange={onChange} placeholder='Digite sua senha.'/>
